    ...
    public void atacar(NPC npc) {
        ...
        switch (opcao) {
            case 1:
                ...
                System.out.println("\n            ATAQUE DO HERÓI \n");
                System.out.println(this.nome + " avança rapidamente, segurando firmemente sua " + armaPrincipal.getNome() + " em posição de estocada...");
                System.out.println(this.nome + " perfura " + npc.nome + " com uma estocada precisa, causando " + (this.forca + armaPrincipal.getAtaque()) + " de dano!");
                ...
                // Ataque do Inimigo
                System.out.println("\n             ATAQUE DO INIMIGO \n");
                System.out.println(npc.nome + " reage rapidamente e ataca " + this.nome + ", causando " + npc.forca + " de dano!");
                System.out.println("\n🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  🔥  \n");
            ...
            case 2:
                ...
                System.out.println(ConsoleColors.GREEN_BOLD + this.nome + " invoca um poder antigo, canalizando energia em sua " + armaPrincipal.getNome() + "...");
