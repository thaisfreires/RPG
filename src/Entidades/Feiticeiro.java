...
public class Feiticeiro extends Heroi{
    public Feiticeiro(String nome, int hp, int forca, int nivel, int ouro, Arma armaPrincipal) {
    ...
    public void atacar(NPC npc) {
        ...
        System.out.println(ConsoleColors.RED_BOLD_BRIGHT + "\nAtaque! O Feiticeiro "+ this.nome+" atacou o " + npc.nome +" !!! " + ConsoleColors.RESET);
        System.out.println(ConsoleColors.RED_BOLD_BRIGHT + "\nAtaque! O "+npc.nome+ " atacou o " + " Feiticeiro " +this.nome +" !!! " + ConsoleColors.RESET);
